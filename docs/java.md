...
:beer: [show-busy-java-threads.sh](../bin/show-busy-java-threads.sh)
----------------------
...
:beer: [show-duplicate-java-classes](../bin/show-duplicate-java-classes)
----------------------
...
:beer: [find-in-jars.sh](../bin/find-in-jars.sh)
----------------------
